...
class AcceptancePolicy(Protocol):
    ...
    def accept(
        self, result: SingleClassificationResult, node: Dict[str, Any] | None = None
    ) -> bool:
        """
...
class ConfidenceThresholdPolicy:
    ...
    def accept(
        ...
        return bool(result and result.is_relevant and result.confidence >= self.min_confidence)
...
class ExcerptRequiredPolicy:
    ...
    def accept(
        ...
        return bool(result and result.is_relevant and result.excerpt and result.excerpt.strip())
